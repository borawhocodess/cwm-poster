  ...
  \begin{block}{Introduction}
    ...
    \heading{Grounding}
      ...
      \begin{itemize}
        ...
        \item \textbf{Dynamic causation (reconstruction principle)}

        \begin{itemize}
          \item If variable $a$ drives $b$ in a dynamical system, then information about $a$ is embedded in the time series of $b$.
          \item Using delay embeddings, there exists an implicit mapping (Takens-style):
          \[
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Results}
    ...
    \begin{itemize}
      \item Lorenz 96 (50x60 - 15) (Fig. \ref{fig:crepfig2lorenz})
      \item Kuramoto power grid (30x120 - 9)
      \item Gene regulatory network (Dream4) (40x50 - 8)
    \end{itemize}
    ...
    \begin{figure}
      ...
      \end{minipage}\hfill
      \caption{Performance of the CReP on Lorenz 96.}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.69\linewidth]{img/crepsupfig4dream.png}
    ...
    \heading{Real datasets}

    \begin{itemize}
      \item Hong Kong cardiovascular inpatients (70x14 - 25) (Fig. \ref{fig:crepfig5hk})
      \item Japan COVID-19 transmission (30x47 - 14)
    \end{itemize}
    ...
    \begin{figure}
      ...
      \end{minipage}\hfill
      \caption{Performance of the CReP on Hong Kong cardiovascular inpatients.}
